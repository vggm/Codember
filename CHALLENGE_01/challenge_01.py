...
if __name__ == '__main__':
  ...
  for index, (test, expected) in enumerate(tests.items()):
    solution = descifrar_mensaje(test)
    if solution == expected:
      print(f'Test {index} passed.')
    else:
      print(f'Test {index} NOT passed.')
      print(f'-> Expected: {expected}, but got {solution}.')
